...
*/
	hier.hier[hier.hi[1]+0].R = FB_REFF_BH * FB_CONST_G*m000/(FB_CONST_C*FB_CONST_C);
	hier.hier[hier.hi[1]+1].R = FB_REFF_BH * FB_CONST_G*m001/(FB_CONST_C*FB_CONST_C);
	hier.hier[hier.hi[1]+2].R = FB_REFF_BH * FB_CONST_G*m01/(FB_CONST_C*FB_CONST_C);
	hier.hier[hier.hi[1]+3].R = FB_REFF_BH * FB_CONST_G*m10/(FB_CONST_C*FB_CONST_C);
	hier.hier[hier.hi[1]+4].R = FB_REFF_BH * FB_CONST_G*m11/(FB_CONST_C*FB_CONST_C);
