...
void print_usage(FILE *stream)
{
	...
	fprintf(stream, "  -F --precision <dsigma/sigma> : set fractional precision on cross\n");
...
int main(int argc, char *argv[])
{
	...
	const char *short_opts = "m:n:o:r:g:i:a:e:v:F:t:D:c:A:R:N:z:y:x:P:Q:S:T:U:k:s:dVh";
