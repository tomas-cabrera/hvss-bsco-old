...
# Get model info
path_to_data = "/home/tomas/Documents/cmu/research/hvss/data/mwgcs"
df_models = pd.DataFrame(os.listdir(path_to_data), columns=["fname"]) 
...
for ci, c in enumerate(columns):
    ...
    # Generate histograms
    df_models["hists"] = hg.generate_catalog_histograms(df_models, pm_pbar=True, path_to_data=path_to_data)
