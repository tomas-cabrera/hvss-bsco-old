...
try:
    ...
    print("\tError in loading data for N={}:".format(N))
    print("\t\t", e)
...
head0 = hvss_utils.SINGLES_HEADERS[:-5] + ("vfin0", "kf0", "Rmin0", "Rmin_j0", "vout0")
head1 = hvss_utils.SINGLES_HEADERS[:-5] + ("vfin1", "kf1", "Rmin1", "Rmin_j1", "vout1")
head2 = hvss_utils.SINGLES_HEADERS[:-5] + ("vfin2", "kf2", "Rmin2", "Rmin_j2", "vout2")
for chunk in data:
